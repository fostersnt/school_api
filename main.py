...
class ItemBase(BaseModel):
    ...
    age: int = Field(...)
    level: str = Field(..., min_length=2, example="A fast 2.4GHz mouse")
...
def create_item(item: ItemCreate):
    raise HTTPException(status_code=500, detail=CustomUtility.apiResponseFormat(False, 'Testing the api', []))
    global id_counter
